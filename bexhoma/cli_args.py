...
def make_base_parser():
    ...
    p.add_argument('-ms',  '--max-sut', help='maximum number of DBMS configurations to run in parallel (default: no limit)', default=None)
    ...
    p.add_argument('-lr',  '--limit-ram', help='RAM limit for the SUT pod (e.g. 64Gi; 0 = no limit)', default='0')
    p.add_argument('-lc',  '--limit-cpu', help='CPU limit for the SUT pod (e.g. 4; 0 = no limit)', default='0')
    p.add_argument('-rr',  '--request-ram', help='RAM request for the SUT pod (e.g. 16Gi)', default='16Gi')
    p.add_argument('-rc',  '--request-cpu', help='CPU request for the SUT pod (e.g. 4)', default='4')
    ...
    p.add_argument('-rst', '--request-storage-type', help='storage class for the SUT persistent volume', default=None, choices=[None, '', 'local-hdd', 'shared', 'ramdisk'])
