...
Provides :class:`BenchbaseCollector`, a thin subclass of :class:`CollectorBase` that wires up
...
__all__ = ["BenchbaseCollector"]


class BenchbaseCollector(CollectorBase):
    """
    Collector for Benchbase experiments.
