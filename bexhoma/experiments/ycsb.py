...
class YcsbExperiment(MixedExperiment):
    ...
    def __init__(self,
        ...
        :param SF: YCSB scaling factor (dataset size in GB; 1 SF ≈ 1 000 000 rows × 1 kB).
        ...
        self.jobtemplate_benchmarking = "jobtemplate-benchmarking-ycsb.yml"
        self.components = {
            "loader": {"sensor": True},
            "benchmarker": {"dbmsbenchmarker": True},
        }
        self.add_benchmark(benchmarks.YCSB(SF=SF))
