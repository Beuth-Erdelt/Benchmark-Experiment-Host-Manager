        ...
        if self.experiment.monitoring_active and 'monitor' in config_K8s:
            ...
            if 'metrics' in config_K8s['monitor']:
                ...
                for metricname, metricdata in config_K8s['monitor']['metrics'].items():
                    ...
                    c['monitoring']['metrics'][metricname]['query'] = c['monitoring']['metrics'][metricname]['query'].format(host=node, gpuid=gpuid, configuration=self.configuration, experiment=self.code)
