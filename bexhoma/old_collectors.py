"""
Deprecated: legacy collector classes superseded by :mod:`bexhoma.collectors`.

Retains :class:`base`, :class:`dbmsbenchmarker`, :class:`benchbase`,
:class:`ycsb`, and :class:`tpcc` collectors for backwards compatibility.
New code should use :mod:`bexhoma.collectors` instead.
