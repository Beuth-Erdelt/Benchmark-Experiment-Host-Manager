...
rules is described separately, in the `## Appendix L. Local agent interface`
section of `handbook_appendix.md`, which sits next to this file.
...
infrastructure papers — and the `## Sources` section of `handbook_appendix.md`
tags each accordingly. Empirical
...
URLs for the citations above. The sources themselves are described in the
`## Sources` section of `handbook_appendix.md`.
