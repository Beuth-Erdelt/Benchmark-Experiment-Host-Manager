...
if __name__ == '__main__':
    ...
    parser.add_argument('-syl', '--synch-loading', help='synch all loading pods of a configuration', default=1)
        ...
        for loading_pods_total in list_loading_pods: # number of loading pods in total
            ...
            if args.dbms == "PostgreSQL":
                ...
                for threads in list_loading_threads:
                    ...
                    config = configurations.yugabytedb(experiment=experiment, docker='YugabyteDB', configuration=name_format.format(cluster=cluster_name, pods=loading_pods_total, split=split_portion, threads=threads), dialect='MySQL', alias='DBMS A1')
