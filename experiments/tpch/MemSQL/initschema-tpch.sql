...
-- Purpose: Create the tpch database and all TPC-H tables in MemSQL.
--          Each table declares a CLUSTERED COLUMNSTORE key which defines the
--          column-store sort order; hash indexes for point lookups are added
--          in initindexes-tpch.sql.
