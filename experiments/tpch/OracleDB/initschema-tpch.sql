...
--          Numeric keys use NUMBER(10,0); monetary amounts use NUMBER.
--          The TRUNCATE statements at the end allow idempotent re-runs.
--          Per TPC-H spec section 1.4.1/1.4.2.1: all table columns may be
--          defined NOT NULL.
...
-- Date columns are read as CHAR(10) text in the external table; conversion to
-- DATE happens on INSERT with NLS_DATE_FORMAT='YYYY-MM-DD'.
...
-- Truncate internal tables to allow idempotent re-runs.
