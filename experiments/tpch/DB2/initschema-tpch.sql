...
-- Purpose: Configure transaction logging, connect to the DB2 instance, and
--          create TPC-H tables in the tpch schema.

CONNECT TO testdb USER db2inst1 USING root1234ROOT;

-- Increase transaction log capacity for bulk loading large TPC-H data sets
