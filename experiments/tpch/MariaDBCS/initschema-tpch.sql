...
-- Purpose: Create the tpch database and TPC-H tables using the MariaDB
--          ColumnStore (columnar) engine. ColumnStore tables do not support
--          primary keys, foreign keys, or secondary indexes.
