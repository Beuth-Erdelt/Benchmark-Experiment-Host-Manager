...
-- Purpose: Bexhoma template for OmniSci TPC-H using INTEGER keys and
--          DECIMAL(16,2) for monetary/quantity values.
...
--          Contrast with initschema-tpch-template.sql (TEXT ENCODING DICT keys)
--          and initschema-tpch-template-decimal.sql (INTEGER keys, DOUBLE).
