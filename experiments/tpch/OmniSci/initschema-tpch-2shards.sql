...
--          and shard_count = 2 (two-node distribution).
--          customer and orders are sharded on the customer key for co-located joins.
--          lineitem has no shard key in this variant.
--          See initschema-tpch-2shards-old.sql for the older PostgreSQL-style variant.
...
CREATE TABLE CUSTOMER (
    ...
    SHARD KEY (C_CUSTKEY)
) WITH (fragment_size = 64000000, shard_count = 2, partitions = 'sharded');
