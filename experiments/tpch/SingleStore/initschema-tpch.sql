-- https://docs.singlestore.com/managed-service/en/create-a-database/creating-a-columnstore-table.html

-- SET GLOBAL leaf_failover_fanout = 'load_balanced';

-- SET CLUSTER snapshots_to_keep = 3;
-- SET GLOBAL snapshots_to_keep = 3;
