...
-- Purpose: Create TPC-H tables with a trailing dummy CHAR(1) column in each
...
CREATE TABLE part (
    ...
    p_retailprice  DECIMAL(16,2)  NOT NULL,
...
CREATE TABLE orders (
    ...
    o_totalprice     DECIMAL(16,2)  NOT NULL,
...
CREATE TABLE lineitem (
    ...
    l_quantity       DECIMAL(16,2)  NOT NULL,
