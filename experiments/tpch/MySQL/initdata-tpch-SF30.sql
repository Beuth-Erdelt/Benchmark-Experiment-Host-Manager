LOAD DATA INFILE '/data/tpch/SF30/customer.tbl' IGNORE INTO TABLE tpch.customer
...
LOAD DATA INFILE '/data/tpch/SF30/lineitem.tbl' IGNORE INTO TABLE tpch.lineitem
FIELDS TERMINATED BY '|'
...
LOAD DATA INFILE '/data/tpch/SF30/nation.tbl' IGNORE INTO TABLE tpch.nation
FIELDS TERMINATED BY '|'
...
LOAD DATA INFILE '/data/tpch/SF30/orders.tbl' IGNORE INTO TABLE tpch.orders
FIELDS TERMINATED BY '|'
...
LOAD DATA INFILE '/data/tpch/SF30/part.tbl' IGNORE INTO TABLE tpch.part
FIELDS TERMINATED BY '|'
...
LOAD DATA INFILE '/data/tpch/SF30/partsupp.tbl' IGNORE INTO TABLE tpch.partsupp
FIELDS TERMINATED BY '|'
...
LOAD DATA INFILE '/data/tpch/SF30/region.tbl' IGNORE INTO TABLE tpch.region
FIELDS TERMINATED BY '|'
(@r_regionkey, @r_name, @r_comment) SET r_regionkey=NULLIF(@r_regionkey,''), r_name=NULLIF(@r_name,''), r_comment=NULLIF(@r_comment,'');

LOAD DATA INFILE '/data/tpch/SF30/supplier.tbl' IGNORE INTO TABLE tpch.supplier
FIELDS TERMINATED BY '|'
