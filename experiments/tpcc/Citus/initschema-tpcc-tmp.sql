...
-- Purpose: HammerDB-generated TPC-C schema for Citus, with pg_dump internal
--          type aliases (int4, int2, bpchar, timestamptz) converted to
--          standard PostgreSQL types. Includes stored procedures and Citus
