...
-- Purpose: Create the tpcds database and all 25 TPC-DS tables in MemSQL
--          (SingleStore) using clustered columnstore indexes. Run once before
...
CREATE TABLE tpcds.customer_address (
    ...
    KEY (`ca_address_sk`) USING CLUSTERED COLUMNSTORE
);
...
CREATE TABLE tpcds.customer_demographics (
    ...
    KEY (`cd_demo_sk`) USING CLUSTERED COLUMNSTORE
);
...
CREATE TABLE tpcds.date_dim (
    ...
    KEY (`d_date_sk`) USING CLUSTERED COLUMNSTORE
);
...
CREATE TABLE tpcds.warehouse (
    ...
    KEY (`w_warehouse_sk`) USING CLUSTERED COLUMNSTORE
);
...
CREATE TABLE tpcds.ship_mode (
    ...
    sm_carrier       CHAR(20),
    sm_contract      CHAR(20),
    KEY (`sm_ship_mode_sk`) USING CLUSTERED COLUMNSTORE
);
...
CREATE TABLE tpcds.time_dim (
    ...
    t_sub_shift   CHAR(20),
    t_meal_time   CHAR(20),
    KEY (`t_time_sk`) USING CLUSTERED COLUMNSTORE
);
...
CREATE TABLE tpcds.reason (
    ...
    KEY (`r_reason_sk`) USING CLUSTERED COLUMNSTORE
);
...
CREATE TABLE tpcds.income_band (
    ...
    KEY (`ib_income_band_sk`) USING CLUSTERED COLUMNSTORE
);
...
CREATE TABLE tpcds.item (
    ...
    KEY (`i_item_sk`) USING CLUSTERED COLUMNSTORE
);
...
CREATE TABLE tpcds.store (
    ...
    KEY (`s_store_sk`) USING CLUSTERED COLUMNSTORE
);
...
CREATE TABLE tpcds.call_center (
    ...
    KEY (`cc_call_center_sk`) USING CLUSTERED COLUMNSTORE
);
...
CREATE TABLE tpcds.customer (
    ...
    KEY (`c_customer_sk`) USING CLUSTERED COLUMNSTORE
);
...
CREATE TABLE tpcds.web_site (
    ...
    KEY (`web_site_sk`) USING CLUSTERED COLUMNSTORE
);
...
CREATE TABLE tpcds.household_demographics (
    ...
    KEY (`hd_demo_sk`) USING CLUSTERED COLUMNSTORE
);
...
CREATE TABLE tpcds.web_page (
    ...
    KEY (`wp_web_page_sk`) USING CLUSTERED COLUMNSTORE
);
...
CREATE TABLE tpcds.promotion (
    ...
    KEY (`p_promo_sk`) USING CLUSTERED COLUMNSTORE
);
...
CREATE TABLE tpcds.catalog_page (
    ...
    cp_type                 VARCHAR(100),
    KEY (`cp_catalog_page_sk`) USING CLUSTERED COLUMNSTORE
);
...
CREATE TABLE tpcds.inventory (
    ...
    KEY (`inv_date_sk`, `inv_item_sk`, `inv_warehouse_sk`) USING CLUSTERED COLUMNSTORE
);
