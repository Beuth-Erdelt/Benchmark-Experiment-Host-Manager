...
-- Purpose: Create the 25 TPC-DS tables in the tpcds database for MariaDB.
--          The tpcds database is assumed to already exist before this runs.

-- Diagnostics: show current buffer and optimizer settings before loading.
