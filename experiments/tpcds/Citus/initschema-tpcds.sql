...
-- Purpose: Create all TPC-DS tables in the public schema for Citus. Primary
--          keys are declared inline. Run before initconstraints-tpcds.sql.
--          Citus worker discovery and join settings are configured at the end.
