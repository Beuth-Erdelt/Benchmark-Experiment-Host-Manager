...
-- Purpose: Load TPC-DS scale factor 100 data into MonetDB using explicit
--          record counts for faster bulk loading. See initdata-tpcds-SF1.sql
--          for the plain COPY INTO format used at smaller scale factors.
