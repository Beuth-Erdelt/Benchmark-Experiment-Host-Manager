...
-- Purpose: Create indexes on TPC-DS tables in MySQL.
--          Run after initconstraints-tpcds.sql and before initstatistics-tpcds.sql.
...
-- idx_catalog_returns_order speeds up NOT EXISTS subqueries on cr_order_number
