...
-- Purpose: Create the tpcds schema and all TPC-DS tables in SAP HANA.
--          Primary keys are declared inline. Run before initdata-tpcds-*.sql.

CREATE SCHEMA tpcds OWNED BY SYSTEM;
